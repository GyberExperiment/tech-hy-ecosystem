...
export interface LPLockerGovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface LPLockerGovernor extends BaseContract {
  connect(runner?: ContractRunner | null): LPLockerGovernor;
  waitForDeployment(): Promise<this>;

  interface: LPLockerGovernorInterface;
