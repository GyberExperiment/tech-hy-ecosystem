...
export interface LPLockerTimelockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CANCELLER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "scheduleCriticalOperation",
    values: [
      AddressLike,
      BigNumberish,
      BytesLike,
...
export namespace CriticalOperationScheduledEvent {
  export type InputTuple = [
    id: BytesLike,
    delay: BigNumberish,
    target: AddressLike,
...
export interface LPLockerTimelock extends BaseContract {
  connect(runner?: ContractRunner | null): LPLockerTimelock;
  waitForDeployment(): Promise<this>;

  interface: LPLockerTimelockInterface;
  ...
  scheduleCriticalOperation: TypedContractMethod<
    [
      target: AddressLike,
      value: BigNumberish,
      data: BytesLike,
  ...
  >;
  getFunction(
    nameOrSignature: "scheduleCriticalOperation"
  ): TypedContractMethod<
    [
      target: AddressLike,
      value: BigNumberish,
  ...
  >;
  getEvent(
    key: "CriticalOperationScheduled"
  ): TypedContractEvent<
    CriticalOperationScheduledEvent.InputTuple,
    CriticalOperationScheduledEvent.OutputTuple,
    CriticalOperationScheduledEvent.OutputObject
  >;
  getEvent(
    key: "MinDelayChange"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "CriticalOperationScheduled(bytes32,uint256,address,string)": TypedContractEvent<
      CriticalOperationScheduledEvent.InputTuple,
      CriticalOperationScheduledEvent.OutputTuple,
      CriticalOperationScheduledEvent.OutputObject
    >;
    CriticalOperationScheduled: TypedContractEvent<
      CriticalOperationScheduledEvent.InputTuple,
      CriticalOperationScheduledEvent.OutputTuple,
      CriticalOperationScheduledEvent.OutputObject
    >;
