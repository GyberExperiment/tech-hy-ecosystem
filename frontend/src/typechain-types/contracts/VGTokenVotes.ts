...
export interface VGTokenVotesInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export interface VGTokenVotes extends BaseContract {
  connect(runner?: ContractRunner | null): VGTokenVotes;
  waitForDeployment(): Promise<this>;

  interface: VGTokenVotesInterface;
  ...
  enableVoting: TypedContractMethod<[], [void], "nonpayable">;
