...
export interface VCTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_SUPPLY"
      | "allowance"
...
export interface VCToken extends BaseContract {
  connect(runner?: ContractRunner | null): VCToken;
  waitForDeployment(): Promise<this>;

  interface: VCTokenInterface;
