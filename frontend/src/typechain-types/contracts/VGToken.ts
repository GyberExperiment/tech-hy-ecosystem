...
export interface VGTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_SUPPLY"
      | "_OWNER_"
...
export namespace OwnershipQueriedEvent {
  export type InputTuple = [querier: AddressLike, owner: AddressLike];
  export type OutputTuple = [querier: string, owner: string];
  export interface OutputObject {
    querier: string;
    owner: string;
  }
...
export interface VGToken extends BaseContract {
  connect(runner?: ContractRunner | null): VGToken;
  waitForDeployment(): Promise<this>;

  interface: VGTokenInterface;
  ...
  >;
  getEvent(
    key: "OwnershipQueried"
  ): TypedContractEvent<
    OwnershipQueriedEvent.InputTuple,
    OwnershipQueriedEvent.OutputTuple,
    OwnershipQueriedEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    ...
    "OwnershipQueried(address,address)": TypedContractEvent<
      OwnershipQueriedEvent.InputTuple,
      OwnershipQueriedEvent.OutputTuple,
      OwnershipQueriedEvent.OutputObject
    >;
    OwnershipQueried: TypedContractEvent<
      OwnershipQueriedEvent.InputTuple,
      OwnershipQueriedEvent.OutputTuple,
      OwnershipQueriedEvent.OutputObject
    >;
