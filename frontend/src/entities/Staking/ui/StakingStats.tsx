...
const CardSkeleton = () => (
  <div className="card animate-pulse animate-enhanced-card-chaos-1">
...
const StakingStats: React.FC = () => {
  ...
  if (!poolData) {
    return (
      <div className="card text-center text-gray-400 animate-enhanced-card-chaos-2">
        <TrendingUp className="mx-auto mb-4" size={48} />
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card animate-enhanced-card-chaos-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          {/* VC баланс */}
          <div className="relative group animate-enhanced-card-chaos-1">
          ...
          {/* BNB баланс */}
          <div className="relative group animate-enhanced-card-chaos-2">
        ...
        <div className="relative group mb-8 animate-enhanced-card-chaos-4">
          ...
          <div className="relative backdrop-blur-xl bg-gradient-to-br from-cyan-500/8 via-blue-500/5 to-purple-500/8 border border-cyan-400/20 rounded-3xl p-8 hover:border-cyan-400/30 transition-all duration-300">
            ...
            {exampleRewards.map((example, index) => (
                <div key={index} className="relative group animate-enhanced-card-chaos-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Статус системы */}
          <div className="relative group animate-enhanced-card-chaos-6">
