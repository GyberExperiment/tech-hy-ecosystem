...
<div align="center">
  ...
  <!-- More Contracts Expandable Section -->
  <details>
    <summary><b>🚀 View All Deployed Contracts (5 more)</b></summary>
    <br>
    <table>
      <tr>
        <td align="center" width="25%">
          <h4>🏛️ Governor</h4>
          <code>0x786133467f52813Ce0855023D4723A244524563E</code>
          <p>DAO governance contract</p>
        </td>
        <td align="center" width="25%">
          <h4>⏱️ Timelock</h4>
          <code>0x06EEB4c972c05BBEbf960Fec99f483dC95768e39</code>
          <p>Governance delay controller</p>
        </td>
        <td align="center" width="25%">
          <h4>💰 VC Token</h4>
          <code>0xC88eC091302Eb90e78a4CA361D083330752dfc9A</code>
          <p>Utility token for LP operations</p>
        </td>
        <td align="center" width="25%">
          <h4>🌊 LP Pool</h4>
          <code>0xA221093a37396c6301db4B24D55E1C871DF31d13</code>
          <p>VC/WBNB liquidity pool</p>
        </td>
      </tr>
    </table>
  </details>
...
<div align="center">
  ...
  <details>
    <summary><b>📋 Complete Scripts List</b></summary>
    <br>
    <table>
      <tr>
        <td align="left" width="50%">
          <h4>🔧 Smart Contract Scripts</h4>
          <ul align="left">
            <li><code>deploy-ecosystem.ts</code> - Deploy all contracts</li>
            <li><code>deploy-tokens.ts</code> - Deploy token contracts</li>
            <li><code>test-ecosystem.ts</code> - Test deployment</li>
            <li><code>complete-deployment.ts</code> - Complete setup</li>
            <li><code>upgrade-lplocker-*.js</code> - Contract upgrades</li>
            <li><code>fix-vg-ownership.js</code> - Fix ownership issues</li>
            <li><code>transfer-vg-to-contract.js</code> - Transfer VG tokens</li>
          </ul>
        </td>
        <td align="left" width="50%">
          <h4>🎯 Testing & Analysis</h4>
          <ul align="left">
            <li><code>test-earnvg-*.js</code> - Test VG earning functionality</li>
            <li><code>check-*.js</code> - Various health checks</li>
            <li><code>verify-*.js</code> - Contract verification</li>
            <li><code>debug-*.js</code> - Debug utilities</li>
            <li><code>find-v3-*.js</code> - V3 pool discovery</li>
            <li><code>create-lp-pool.js</code> - Create liquidity pools</li>
          </ul>
        </td>
      </tr>
    </table>
